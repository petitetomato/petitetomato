...
<link rel="stylesheet" href="respons.css" media="screen and (max-width:767px)">
<meta name="keywords" content="焼き菓子のお店/福岡市">
<meta name="description" content="お店のお菓子を紹介しています。お菓子の写真を載せています。">
<title>SweetsShopTomoko　ドリンクメニュー</title>
</head>
<body>
<div id="wrap">
<header id="pagehead">
  ...
  <div id="breadcrumb">
  	<p><a href="index.php">トップページ</a>&nbsp;&gt;&nbsp;ドリンクメニューページ</p>
  </div>
  <div id="contents">
  <article id="menu">
    <p>
      テイクアウトのドリンクも販売してます。<br>フレンチプレスに使用しているコーヒーは、豆の販売も出来ます。<br>
      春～秋の間は、入口の外に少しだけお席をご用意してます。<br>
    </p>
    <h1><img src="images/drink_menu.jpg" alt="ドリンクメニュー"></h1>
  </article>
  </div>
  <footer>
    <div id="back">
